...
export async function getAuthOptions(): Promise<NextAuthOptions> {
    ...
    // Prioritize configured hostname/IP from database over auto-detected NEXTAUTH_URL
    // This ensures OAuth callbacks use the correct public URL, not internal IPs
    ...
    // If neither is configured, keep existing NEXTAUTH_URL from environment
